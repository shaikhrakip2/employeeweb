            ...
            <div class="card">
              <div class="card-header d-flex justify-content-end">
                <div class="card-title pull-right">
                  <a href="{{ url('admin/blog_categories/create')}}" class="btn bg-success"><i class="fa fa-plus"></i> Add Blog Category</a>
                </div>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    $.ajaxSetup({
      ...
      tableObj = $('.datatable').DataTable({
          ...
          bLengthChange: false,
          type: 'GET',
          ajax: '{{ url("admin/blog_categories") }}',
          order: [[ 0, "asc" ]],   
          columns   : [ 
            { data : 'name' },
  ...
  $("body").on("change",".tgl_checkbox",function(){ 
    $.post('{{ url("admin/blog_categories/status") }}',
    {
      _token:"{{ csrf_token() }}",
      id : $(this).data('id'),

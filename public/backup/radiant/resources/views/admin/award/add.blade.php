                    ...
                    <div class="card">
                        <div class="card-header d-flex justify-content-end">
                            <div class="card-title pull-right">
                                <a href="{{ url('admin/awards') }}" class="btn btn-success"><i class="fa fa-list"></i> Awards
                                    List</a>
                            </div>
                        </div>
                        <form id="awardForm" method="post" action="{{ url('admin/awards') }}"
                            ...
                            <div class="card-body">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="title" class="form-control"
                                                value="{{ old('title') }}" id="title" placeholder="Enter Award Title">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="date" name="date" class="form-control"
                                                value="{{ old('date') }}" id="date" placeholder="Enter Award Date">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="short_description">Short Description<i
                                                    class="text-danger">*</i></label>
                                            <textarea type="text" name="short_description" class="form-control" id="short_description"
                                                placeholder="Enter Award Short Description">{{ old('short_description') }}</textarea>

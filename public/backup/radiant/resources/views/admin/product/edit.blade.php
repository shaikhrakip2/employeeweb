   ...
   <div class="row">
      <div class="col-12">
         <div class="card">
            ...
            <form id="accessoryForm" method="post" action="{{ url('admin/product', ['id' => $data->id]) }}"
                     ...
                     <div class="tab-pane fade show active" id="home" role="tabpanel"
                        ...
                        <div class="col">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <option value="">Select Is Trending Or Not</option>
                                            <option value="1" {{ ($data->is_trending == '1') ? 'selected' : '' }}>Yes</option>
                                            <option value="0" {{ ($data->is_trending == '0') ? 'selected' : '' }}>No</option>
                                                </select>
                                    ...
                                    <div class="form-group">
                                       ...
                                       <select name="is_top" id="is_top" class="form-control">
                                             ...
                                             <option value="1" {{ ($data->is_top == '1') ? 'selected' : '' }}>Yes</option>
                                             <option value="0" {{ ($data->is_top == '0') ? 'selected' : '' }}>No</option>
                                       </select>
                           ...
                           <div class="col-md-6">
                              <div class="form-group">
                                 ...
                                 <p><img src="{{ asset($data->default_image) }}"
                                    class="image logosmallimg">
                                 </p>
                                 @endif
                           ...
                           <div class="col">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="sort_order" class="form-control"
                                                value="{{ old('sort_order', $data->sort_order) }}" id="sort_order"
                        ...
                        <div class="row">
                           <div class="col-md-12">
                              <div class="form-group">
                                 ...
                                 <textarea id="sort_description" name="sort_description" class="form-control" rows="2">{{ old('sort_description', $data->sort_description) }}</textarea>
                           ...
                           <div class="col-md-12">
                              <div class="form-group">
                                 <label for="description">Description<i
                                    class="text-danger">*</i></label>
                                 <textarea id="description" name="description" class="form-control ckeditor" rows="5">{{ old('description', $data->full_description) }}</textarea>
                        ...
                        <div class="row">
                           <div class="col-md-12">
                              <div class="form-group">
                                 ...
                                 <select name="main_parent_id"  id="main_parent_id" class="form-select getsubcategroy">
                                 ...
                                 <div class="row"><label id="category_id-error" class="error" for="category_id"></label></div>

      ...
      <div class="row">
        <div class="col-12">
          <div class="card">
            ...
            <form id="roleForm" method="post" action="{{ url('admin/role', ['id' => $data->id]) }}">
              @method('PUT')
              @csrf
              <div class="card-body">
                <div class="row">
                  <div class="col-6">
                    <div class="form-group">
                      ...
                      <input type="text" name="name" class="form-control" id="name" value="{{old('name', $data->name)}}" placeholder="Enter Role name">

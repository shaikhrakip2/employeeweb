            ...
            <div class="card">
              <div class="card-header d-flex justify-content-end">
                <div class="card-title pull-right">
                  <a href="{{ url('admin/faq-categories/create')}}" class="btn bg-success"><i class="fa fa-plus"></i> Add Faq Category</a>
                </div>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
...
<script type="text/javascript">
  ...
  $("body").on("change",".tgl_checkbox",function(){ 
    $.post('{{ url("admin/faq-categories/status") }}',
    {
      _token:"{{ csrf_token() }}",
      id : $(this).data('id'),

            ...
            <div class="card">
              <div class="card-header d-flex justify-content-end">
                <div class="card-title pull-right">
                  <a href="{{ url('admin/event')}}" class="btn btn-success"><i class="fa fa-list"></i> Event Lists</a>
                </div>
              </div>
              <form id="eventForm" method="post" action="{{ url('admin/event') }}"  enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                <div class="row">
                <div class="col-md-6">
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="text" name="title" class="form-control" value="{{ old('title') }}" id="title" placeholder="Enter Event title">
                        @error('title')
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="date" name="date" class="form-control" value="{{ old('date') }}" id="date" placeholder="Enter Event Date">
                        @error('date')
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="text" name="sort_order" class="form-control" value="{{ old('sort_order') }}" id="sort_order" placeholder="Enter Event Sort Order"  onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g, '')">
                        @error('sort_order')
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        <label for="description">Event Sort Description<i class="text-danger">*</i></label>
                        <textarea id="sort_description" name="sort_description" class="form-control" id="sort_description" placeholder="Enter Event Sort Description">{{ old('sort_description') }}</textarea>
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        <label for="description">Event Description<i class="text-danger">*</i></label>

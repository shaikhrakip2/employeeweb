...
<body class="">
    <header class="bg-info dk header navbar navbar-fixed-top-xs">
        <div class="navbar-header aside-md"> <a class="btn btn-link visible-xs" data-toggle="class:nav-off-screen,open"
                ...
                data-toggle="fullscreen"><img src="{{ url('frontend/images/logoadiyogi.png') }}" class="m-r-sm">
                </a> <a class="btn btn-link visible-xs" data-toggle="dropdown" data-target=".nav-user"> <i

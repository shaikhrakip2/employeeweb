                            ...
                            <nav class="nav-primary hidden-xs">
                                <ul class="nav">
                                    ...
                                    <li class="active">
                                        ...
                                        <ul class="nav lt">
                                            <li class="active"> <a href="{{ route('addnewemployee') }}" class="active">
                                                    <i class="fa fa-angle-right"></i> <span><b>Add New
                                                            Employees</b></span>
                                                </a> </li>

                                            <li class="active"> <a href="{{ route('totalemployee') }}"> <i
                                    ...
                                    <li class="active">
                                        <a href="" class="active">
                                            ...
                                            <span>Office</span> </a>
                                        <ul class="nav lt">
                                            <li class="active"> <a href="{{ route('mobiledeveloper') }}" class="active">
                                                    <i class="fa fa-angle-right"></i> <span><b>Mobile
                                                            Developers</b></span>
                                                </a> </li>
                                            <li class="active"> <a href="{{ route('developersviewtable') }}"

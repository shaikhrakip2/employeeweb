        ...
        <section class="panel panel-default">
            ...
            <div class="panel-body">
                <form action="{{ route('data-store') }}" method="POST">
                    ...
                    <div class="form-group"> <label>phone No</label> <input type="phone"
                            class="form-control" name="phone" placeholder="Enter Your phone No" 
                    ...
                    <div class="form-group"> <label>Designation</label> <input type="designation"
                            class="form-control" name="designation" placeholder="Enter Your designation" 
                            
                            > </div>

                    <div class="form-group"> <label>Company</label> <input type="company"
                            class="form-control" name="company" placeholder="Enter Your company" 
                            
                            > </div>
                    <div class="form-group"> <label>Working_experience</label> <input type="working_experience"
                            class="form-control" name="working_experience" placeholder="Enter Your working_experience" 
